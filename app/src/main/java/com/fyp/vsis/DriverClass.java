...
public class DriverClass extends AppCompatActivity {
    ...
    public void btn_fetch(View v)
    {
        ...
        String url = "https://vsis-18c44-default-rtdb.firebaseio.com/Registered-users/"+number+"/name";
        String url2 = "https://vsis-18c44-default-rtdb.firebaseio.com/Registered-users/"+number+"/phoneNo";
